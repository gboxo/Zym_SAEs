...
#SBATCH --output=eval_SAEs_diffing_sapi_rl_%j.out             # Output file
#SBATCH --error=eval_SAEs_diffing_sapi_rl_%j.err              # Error file
...
for i in "${iterations[@]}"; do
  ...
  output_file="$output_dir/config_${i}_rl_brenda.yaml"
  ...
  paths:
    ...
    is_tokenized: true
    out_dir: /home/woody/b114cb/b114cb23/boxo/diffing_sapi_07_04/eval_SAEs_RL_${i}_brenda/
