#!/bin/bash -l
#SBATCH --job-name=Iterative_Latent_Scoring_Diffing_SAPI_BM          # Job name
#SBATCH --ntasks=1                        # Run 1 task (process)
#SBATCH --partition=spr1tb
#SBATCH --time=24:00:00                   # Time limit
#SBATCH --output=iterative_latent_scoring_bm_%j.out             # Output file
#SBATCH --error=iterative_latent_scoring_bm_%j.err              # Error file
