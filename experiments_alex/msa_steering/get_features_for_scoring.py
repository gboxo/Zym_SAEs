...
def obtain_features(sequences, mutant, output_dir):
    ...
    pkl.dump(features_dict, open(f"{output_dir}/features/features.pkl", "wb"))
    del features
    torch.cuda.empty_cache()
...
if __name__ == "__main__":
    ...
    output_dir = "/home/woody/b114cb/b114cb23/boxo/msa_steering/latent_scoring_base/"
    seqs_path = "/home/woody/b114cb/b114cb23/boxo/msa_steering/activity_predictions.csv"
