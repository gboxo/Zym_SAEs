...
output_dir="experiments_alex/strong_steering/configs_scoring"
mkdir -p "$output_dir"
...
for top_features_path in /home/woody/b114cb/b114cb23/boxo/strong_steering/latent_scoring_base_o2/important_features/important_features_pos_M0_D0_*; do
  ...
  out_dir="/home/woody/b114cb/b114cb23/boxo/strong_steering/latent_scoring_base_o2/ablation_with_all/M0_D0_${name}"
...
EOL
  ...
  python3 -m experiments_alex.strong_steering.generate_with_ablation \
    --cfg_path "$gen_cfg"
  done

for top_features_path in /home/woody/b114cb/b114cb23/boxo/strong_steering/latent_scoring_base_o2/ablation_with_all/M0_D0_*; do
  ...
  out_dir="/home/woody/b114cb/b114cb23/boxo/strong_steering/latent_scoring_base_o2/ablation_with_all/${name}/"
