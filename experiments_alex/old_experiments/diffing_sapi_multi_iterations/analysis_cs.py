...
# Display the plot
plt.savefig("cs_plot_multi_iterations_markers_alpha_highlighted_from_DMS_rl_topk.png") # Updated filename
plt.savefig("cs_plot_multi_iterations_markers_alpha_highlighted_from_DMS_rl_topk.pdf", dpi=300) # Updated filename
