...
def main(label, model,special_tokens,device,tokenizer,temp):
...
if __name__=='__main__':
    ...
    model_name = "/home/woody/b114cb/b114cb23/ZF_FT_alphaamylase_gerard/FT_3.2.1.1/"
    ...
    for temp in np.arange(0.3,1.3,0.3):
        all_sequences = []
        for i in tqdm(range(10)):
            sequences = main(label, model, special_tokens, device, tokenizer,temp)
        ...
        out_dir = "/home/woody/b114cb/b114cb23/boxo/strong_steering/seq_gen/"
        os.makedirs(out_dir, exist_ok=True)
        output_filename = f"{out_dir}/seq_gen_{label}_{temp}_ZC_FT.fasta"
        print(fasta_content)
