#!/bin/bash -l
#SBATCH --job-name=Latent_Scoring_Diffing_SAPI_RL          # Job name
#SBATCH --ntasks=1                        # Run 1 task (process)
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=a100
#SBATCH --constraint=a100_80
#SBATCH --time=24:00:00                   # Time limit
#SBATCH --output=latent_scoring_rl_%j.out             # Output file
#SBATCH --error=latent_scoring_rl_%j.err              # Error file
...
output_dir="experiments_alex/diffing_sapi_multi_iterations_from_DMS/configs_scoring"
mkdir -p $output_dir
...
for i in "${iterations[@]}"; do
  ...
  paths:
    ...
    sae_path: $sae_path
    out_dir: /home/woody/b114cb/b114cb23/boxo/diffing_sapi_multi_iterations_from_DMS/latent_scoring/latent_scoring_${i}_rl/
