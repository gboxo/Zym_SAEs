...
path = "/home/hpc/b114cb/b114cb23/SAETraining/boxo/finetune_SAE_DMS/ablation_with_all/importance/M0_D0_pos_new"

fasta_files = [os.path.join(path, elem) for elem in os.listdir(path) if elem.endswith(".txt")]
all_dfs = []
...
for _, row in all_dfs.iterrows():
    ...
    seq = row['sequence']
    feature = row['feature']
    output_dir = f"/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/ablation_with_all/importance/M0_D0_pos_new/PDB"
