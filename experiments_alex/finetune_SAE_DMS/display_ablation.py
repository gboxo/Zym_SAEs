...
if __name__ == "__main__":
    ...
    BASE_AB = "/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/ablation_with_all/importance/"
    ab_df = join_ablation_csvs(BASE_AB)
    print(ab_df)
    os.makedirs("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation", exist_ok=True)
    ab_df.to_csv("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/all_ablation_preds.csv", index=False)
    ...
    plt.tight_layout()
    plt.savefig("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/ablation_split_with_mc_original_all.png")
    ...
    for ax in h.axes.flatten():
        ...
        ax.set_xticklabels(["pos", "neg", "original"])
    plt.tight_layout()
    plt.savefig("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/ablation_avg_with_mc_original_all.png")


    # 1) Load the joined ablation‐predictions CSV
    #    It must contain: model_it, dir_it, name, index, prediction1, prediction2
    df = pd.read_csv("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/all_ablation_preds.csv")
    ...
    plt.tight_layout()
    plt.savefig("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/ablation_split_violins_with_base_all.png")
    ...
    plt.tight_layout()
    plt.savefig("/home/woody/b114cb/b114cb23/boxo/finetune_SAE_DMS/figures_ablation/ablation_avg_with_mc_base_fixed_all.png", dpi=150)
    plt.show()