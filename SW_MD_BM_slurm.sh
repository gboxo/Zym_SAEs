...
output_dir="configs/diffing_exp2"
mkdir -p $output_dir
...
for i in "${iterations[@]}"; do
  ...
  if [ "$i" = "0" ]; then
    ...
    prev_iter=$((${i}-1))
    resume_from="/home/woody/b114cb/b114cb23/ZymCTRLSAEs/checkpoints/Diffing Alpha Amylase/M0_D${prev_iter}/diffing"
  fi
...
resuming:
  ...
  checkpoint_dir_to: /home/woody/b114cb/b114cb23/ZymCTRLSAEs/checkpoints/Diffing Alpha Amylase/M0_D${i}
  resuming: true
  n_iters: 20
  model_diffing: true
EOL
