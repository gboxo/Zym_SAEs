...
do
    ...
    python3 -m src.tools.data_utils.create_diffing_dataset --cfg_path create_diffing_dataset_cfg.yaml --iteration_num ${i}
    done
...
do
    ...
    python3 -m src.tools.data_utils.generate_dataframe --cfg_path generate_dataframe_cfg.yaml --iteration_num ${i}
done
