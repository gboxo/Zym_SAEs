#!/bin/bash -l
#SBATCH --job-name=SAE_Train_2b_1         # Job name
#SBATCH --ntasks=1                        # Run 1 task (process)
#SBATCH --gres=gpu:a100:1
#SBATCH --partition=a100
#SBATCH --constraint=a100_80
#SBATCH --time=24:00:00                   # Time limit
#SBATCH --output=slurm_sae_1_%j.out    # Output file
#SBATCH --error=slurm_sae_1_%j.err     # Error file
...
python3 -m run_topk --config configs/sae_training_2b_32_15360_5//config_sae_2b_iter_1.yaml
