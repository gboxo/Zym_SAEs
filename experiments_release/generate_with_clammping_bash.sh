...
top_features_path="/home/woody/b114cb/b114cb23/boxo/unified_experiments/ablation/importance/dms_model/important_features/important_featuresdms_model_50.pkl"
...
python3 -m src.tools.generate.experiments_runner --cfg_path $gen_cfg --experiment_type clampping
