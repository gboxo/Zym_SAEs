...
def init_wandb(cfg):
    return wandb.init(project=cfg["wandb_project"], name=cfg["name"], config=cfg, reinit=True, dir = "/home/woody/b114cb/b114cb23/boxo/")
...
def save_checkpoint(checkpoints_path,wandb_run, sae, cfg, step):
    save_dir = f"{checkpoints_path}/checkpoints/{cfg['name']}_{step}"
