...
output_dir="configs/diffing_RL_32"
mkdir -p $output_dir
...
for i in "${iterations[@]}"; do
  ...
  if [ "$i" = "1" ]; then
    ...
    model_path="/home/woody/b114cb/b114cb23/Filippo/Q4_2024/DPO/DPO_Clean/DPO_clean_amylase_run_SAPI_only_gerard/output_iteration${i}"
  fi
...
training:
  dataset_path: /home/woody/b114cb/b114cb23/boxo/diffing_dataset_mixture/dataset_iteration${i}/
